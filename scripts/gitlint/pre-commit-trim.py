...
# The blanks sed's [[:space:]] would strip, minus the line terminators, which are put back after the trim.
BLANKS = b" \t\v\f"
EOLS = (b"\r\n", b"\n", b"\r")
...
def main():
    ...
    # Bytes in, bytes out: the commit message encoding is git's business (i18n.commitEncoding) and trailing whitespace
    # is ASCII either way, so nothing here has to decode the message and risk failing on it.
